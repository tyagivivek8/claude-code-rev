...
const DEFAULT_PREFIX = `You are Clawd Code, a CLI for Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Clawd Code, a CLI for Claude, running within the Clawd Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Claude agent, built on Anthropic's Clawd Agent SDK.`
