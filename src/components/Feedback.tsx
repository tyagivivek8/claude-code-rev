...
async function submitFeedback(data: FeedbackData, signal?: AbortSignal): Promise<{
  ...
  if (isEssentialTrafficOnly() || isEnvTruthy(process.env.CLAUDE_CODE_USE_COPILOT)) {
    return {
      success: false
    };
  }
