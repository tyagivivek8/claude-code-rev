    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport requires a Clawd.ai account.</Text><Text dimColor={true}>Your Clawd Pro/Max subscription will be used by Clawd Code.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
