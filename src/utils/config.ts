...
export type GlobalConfig = {
  ...
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Clawd Code OAuth token
  ...
  // Clawd Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
